...
public class ReceiptController {
    ...
    @GetMapping(path = "/viewReceipt")
    public ResponseEntity<List<ReceiptModel>> viewReceipt(@RequestParam("personalAccount") Long personalAccount) {
        try {
            return ResponseEntity.ok(receiptService.viewReceipt(personalAccount));
